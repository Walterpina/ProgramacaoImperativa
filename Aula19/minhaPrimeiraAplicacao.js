...
function calcular() {//nesta funçção eu não coloquei um elemento pq tudo está dentro dela
  ...
  pessoas.sort(function(a, b) { //esta função está colocando em ordem os valores do menor para o maior
    return a.altura - b.altura;// a ordem é crescente como está determinado aqui em a - b, ou seja,
  ...
  for(let i = 0; i < pessoas.length; i++) {
    if(pessoas[i].sexo === "F") {
      ...
      alturaMulheres += pessoas[i].altura;//aqui é feita a contagem da altura das mulheres
  ...
  console.log('A menor altura registrada é: ' + pessoas[0].altura); //aqui eu seleciono o menor valor (pegando do índice 0)
  console.log('A maior altura registrada é: ' + pessoas[15].altura); //aqui eu seleciono o maior valor (pegando do índice 15)
