...
function Estudante(nome, faltas, notas) {
    ...
    this.calcularMedia = function(){
        let media = (this.notas[0] + this.notas[1] + this.notas[2] + this.notas[3]) / this.notas.length;
        return media;
    };
...
// let lista = [];
// lista.push(new Estudante(estudante.nome, estudante.faltas, estudante.notas));
// console.log(lista);
